...
const DegreesToTurnTracker = (function () {
  ...
  function updateReverse(currentLocation){
    ...
    let rearwheelPosition = turf.rhumbDestination(currentLocation, antennaToRearAxleDistance / 1000, reverseDriveBearing).geometry.coordinates; // 2 meter achteruit voor wielen
