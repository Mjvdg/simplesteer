...
io.on('connection', (socket) => {
  ...
  socket.on('saveMachineSettings', ({ antennaHeight, antennaToFrontAxleDistance, antennaToRearAxleDistance, maxSteeringAngle, isReverseSteeringEnabled }) => {
    DB.setMachineSettinges(antennaHeight, antennaToFrontAxleDistance, antennaToRearAxleDistance, maxSteeringAngle, isReverseSteeringEnabled);
    IoSend.sendSaveSettingsSuccess(socket);
  })
