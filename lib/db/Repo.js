...
class Repo {
  ...
  static setMachineSettinges(antennaHeight, antennaToFrontAxleDistance, antennaToRearAxleDistance, maxSteeringAngle) {
    db.set('settings.machine', { antennaHeight, antennaToFrontAxleDistance, antennaToRearAxleDistance, maxSteeringAngle }).write();
  }
